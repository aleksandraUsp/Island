...
import com.javarush.uspenskaya.island.entities.Organism;
import com.javarush.uspenskaya.island.entities.herbivore.*;
...
public class Buffalo extends Herbivore {
    ...
    public Buffalo(int mass, int speed, int maxQuality, int saturation, String icon) {
